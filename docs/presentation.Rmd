...
food production (see Koren, 2018 and Buhaug et al., 2015)
- research activities on violent conflicts are found between inferential statistics
and prediction models (see Ward et al, 2010)
- automated collection of highly disaggregated conflict event data enables analysis
on very high levels of detail
