# AUC and AUPR calculation for EV models at admin level
...
conflicts %<>%
  filter(unit == "basins", time > as.Date("2000-12-01"), id <= 847)

predictors %<>%
  filter(unit == "basins", time > as.Date("2000-12-01"), id <= 847, !var %in% c("AGRANOM", "AGRANOM_50", "AGRANOM_100", "AGRANOM_200",
