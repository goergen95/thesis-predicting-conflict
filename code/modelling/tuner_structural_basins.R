# Bayesian Optimization of SV baseline CNN-LSTM for basin level
...
data = split_data(data_pred = predictors, data_conf = conflicts, thres = 0, y_var = "all", seed = seed)
