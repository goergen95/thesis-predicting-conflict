...
```{r read-data}
files = list.files("../data/vector/extraction/", pattern = "LVSTK", full.names = T)
...
data %>%
  ...
  theme_classic() +
  labs(y="Count", x = "Livestock", color = "Unit of Analysis", fill = "Unit of Analysis")
...
```{r map-value}
tm_shape(plt_data) +
  tm_polygons(col = "value", palette = "-RdYlBu", style = "jenks", border.col = "gray", lwd = .5) +
  tm_facets("unit")
```
