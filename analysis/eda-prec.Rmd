...
```{r read-data}
files = list.files("../data/vector/extraction/", pattern = "_PREC", full.names = T)
...
```{r map-states-value}
tm_shape(poly_adm) +
  tm_polygons(col = "value", palette = "RdYlBu", breaks = c(0,25,50,100,150,250,500,750,1000,+Inf), border.col = "white", lwd = .5) +
  tm_facets("month")
```
